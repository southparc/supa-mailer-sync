  ...
  public: {
    Tables: {
      ...
      ml_subscriber_groups: {
        ...
        Relationships: [
          {
            foreignKeyName: "ml_subscriber_groups_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "ml_groups"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "ml_subscriber_groups_subscriber_id_fkey"
            columns: ["subscriber_id"]
            isOneToOne: false
            referencedRelation: "ml_subscribers"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      ml_sync_state: {
        Row: {
          ...
          last_incremental_since: string | null
        }
        Insert: {
          id?: boolean
          last_full_backfill_at?: string | null
