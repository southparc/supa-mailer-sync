...
async function verifyAdmin(req: Request, supabase: SupabaseClient): Promise<{ userId: string | null, error: Response | null }> {
...
serve(async (req) => {
  ...
  console.log(`Admin user ${userId} initiated smart-sync`);
